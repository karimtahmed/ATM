 ...
 * @author karem
 */
public class client3_func extends javax.swing.JFrame {

    /**
     * Creates new form client31_func
     */
    int balance=5000;
    public client3_func() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(client3_func.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new client3_func().setVisible(true);
            }
        });
    }
